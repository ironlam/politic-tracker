...
export const MANDATE_CATEGORY_ORDER: MandateType[][] = [
  ...
  // Local (ligne 2)
  ["PRESIDENT_REGION", "PRESIDENT_DEPARTEMENT", "MAIRE", "ADJOINT_MAIRE", "CONSEILLER_REGIONAL", "CONSEILLER_DEPARTEMENTAL", "CONSEILLER_MUNICIPAL"],
];
...
export const MANDATE_ROW_LABELS = [
  "Exécutif",
  "Parlement",
  "Local",
  "Autre",
