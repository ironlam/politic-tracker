...
function extractDepartmentCode(constituency: string | null, type: MandateType): string | null {
  ...
  if (
    constituency.includes("Saint-Barthélemy et Saint-Martin") ||
    constituency.includes("Saint-Barthélémy et Saint-Martin")
  ) {
  ...
  if (
    constituency.includes("Français établis hors de France") ||
    constituency.includes("Francais etablis hors de France")
  ) {
    return "099";
  }
