    ...
    <footer role="contentinfo" className="border-t bg-muted/30 mt-auto">
      <div className="container mx-auto px-4 py-8 md:py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Primary navigation */}
          <nav aria-labelledby="footer-nav-explore">
            <h3 id="footer-nav-explore" className="font-semibold text-sm mb-3">Explorer</h3>
          ...
          <nav aria-labelledby="footer-nav-discover">
            <h3 id="footer-nav-discover" className="font-semibold text-sm mb-3">Découvrir</h3>
            <ul className="space-y-2 text-sm">
